  ...
  <div>
    <div>
      <el-input
          ...
          @keydown.enter.native="addPisitions"
          v-model="pos.name">
      </el-input>
      <el-button
          icon="el-icon-plus"
    ...
    <div class="posManaMain">
      ...
      >
        ...
        <el-table-column prop="enabled" label="是否启用" width="88">
...
export default {
  ...
  methods: {
    ...
    handleDelete(index, data) {
      this.$confirm('此操作将删[' + data.name + ']职位, 是否继续?', '提示', {
    ...
    deleteMany() {
      this.$confirm(
          '此操作将删[' + this.multipleSelection.length + ']条职位, 是否继续?',
          '提示',
          {
            confirmButtonText: '确定',
            cancelButtonText: '取消',
